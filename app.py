...
if not exportaciones_filtradas.empty:
    ...
    st.warning("No hay datos de exportación para el país seleccionado.")
...
if "País" in mercados.columns and "Tamaño del Mercado (USD millones)" in mercados.columns:
    ...
    st.error("No se encontraron columnas esperadas para el análisis comparativo.")
